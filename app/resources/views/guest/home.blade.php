                ...
                <div class="img-src">
                    <div class="fadeOut owl-carousel owl-theme">
                        @foreach($banners as $banner)
                            <div class="item">
                                <img src="assets/img/welcome/{{ $banner->filename }}" alt="Awesome Image" style="height: 100vh !important; with: 100%">
                            </div>
                        @endforeach
                    </div>
                </div>
            ...
            <div class="fadeOut owl-carousel owl-theme">
                @foreach($news as $new)
                    <div class="item"
                        ...
                        <center>
                            <img src="{{ url('assets/img/news/'.$new->filename) }}"
                                 alt="{{ url('assets/img/news/'.$new->filename) }}"
